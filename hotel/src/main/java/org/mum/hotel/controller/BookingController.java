...
@Controller
@SessionAttributes(value={"checkIn","checkOut","customer"})
public class BookingController {
	...
	public String customerRegistration(){
		return "/booking/customerRegister";
	}
	
	@RequestMapping(value="/saveCustomer", method=RequestMethod.POST)
	public String saveCustomer(@RequestParam Map<String,String> allParams,Model model){
		String fname =allParams.get("fname");
		...
		Customer customer = new Customer(fname,lname,email,phone,street,city,state);
	...
	public String roomBooking(@Valid @ModelAttribute("booking")Booking booking,BindingResult result,@RequestParam Map<String,String> allRequestParams,Model model){
		...
		String checkIn = allRequestParams.get("checkInDate"); 
		String checkOut = allRequestParams.get("checkoutDate");
	...
	public String userConfirm(@ModelAttribute("booking")Booking booking,@RequestParam Map<String,String> allParams,@RequestParam("custNo") String custNo,ModelMap model){
